...
class Ui_ArmControl(object):
    def setupUi(self, ArmControl):
        ...
        ArmControl.setWindowModality(QtCore.Qt.WindowModality.NonModal)
        ArmControl.resize(482, 537)
        ArmControl.setMaximumSize(QtCore.QSize(16777215, 16777215))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../roboticArm.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"")
        self.xUp.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("up.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.xVal.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.xVal.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.xVal.setLineWidth(1)
        self.xVal.setMidLineWidth(0)
        self.xVal.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.yVal.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.yVal.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.yVal.setLineWidth(1)
        self.yVal.setMidLineWidth(0)
        self.yVal.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.rollVal.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.rollVal.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.rollVal.setLineWidth(1)
        self.rollVal.setMidLineWidth(0)
        self.rollVal.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.zVal.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.zVal.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.zVal.setLineWidth(1)
        self.zVal.setMidLineWidth(0)
        self.zVal.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.xLabel.setFrameShape(QFrame.Shape.Panel)
        self.xLabel.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
...
"")
        self.xDown.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("down.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"")
        ...
        self.yLabel.setFrameShape(QFrame.Shape.Panel)
        self.yLabel.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        ...
        self.zLabel.setFrameShape(QFrame.Shape.Panel)
        self.zLabel.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.zLabel.setLineWidth(1)
        self.zLabel.setMidLineWidth(0)
        self.zLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        self.rollLabel.setFrameShape(QFrame.Shape.Panel)
        self.rollLabel.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.rollLabel.setLineWidth(1)
        self.rollLabel.setMidLineWidth(0)
        self.rollLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("../closeIcon.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.pitchVal.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.pitchVal.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.pitchVal.setLineWidth(1)
        self.pitchVal.setMidLineWidth(0)
        self.pitchVal.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
...
"")
        ...
        self.pitchLabel.setFrameShape(QFrame.Shape.Panel)
        self.pitchLabel.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
...
"")
        ...
        self.yawVal.setFrameShape(QtWidgets.QFrame.Shape.Box)
        self.yawVal.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.yawVal.setLineWidth(1)
        self.yawVal.setMidLineWidth(0)
        self.yawVal.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
...
"")
        ...
        self.yawLabel.setFrameShape(QFrame.Shape.Panel)
        self.yawLabel.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.yawLabel.setLineWidth(1)
        self.yawLabel.setMidLineWidth(0)
        self.yawLabel.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
